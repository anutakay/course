...
public class BoxTest {
    ...
    public void cteateTest() {
        Box box = new BoxImpl(new Size(2, 2, 2, new Weight(2)));
        assertNotNull(box);
    }

    @Test(expected = UncompatibleValueException.class)
    public void createNullSizeTest() {
        new BoxImpl(new Size(0, 0, 0, new Weight(2)));
    }

    @Test(expected = UncompatibleValueException.class)
    public void createNullWeightTest() {
        new BoxImpl(new Size(2, 2, 2, new Weight(0)));
    }

    @Test(expected = UncompatibleValueException.class)
    public void createNullTest() {
        new BoxImpl(new Size(0, 2, 2, new Weight(0)));
    }
